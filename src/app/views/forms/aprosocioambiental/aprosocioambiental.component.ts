...
@Component({
  selector: 'app-aprosocioambiental',
  templateUrl: './aprosocioambiental.component.html',
  styleUrls: ['./aprosocioambiental.component.scss']
})
export class AprosocioambientalComponent {
