...
@Component({
  selector: 'app-aprobacion-evalsa',
  templateUrl: './aprobacion-evalsa.component.html',
  styleUrls: ['./aprobacion-evalsa.component.scss']
})
export class AprobacionEvalsaComponent {
  datos: any = [];  
  filterPost!: string;
  p: number = 1;
