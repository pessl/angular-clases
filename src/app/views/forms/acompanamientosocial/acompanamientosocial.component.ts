...
@Component({
  selector: 'app-acompanamientosocial',
  templateUrl: './acompanamientosocial.component.html',
  styleUrls: ['./acompanamientosocial.component.scss']
})
export class AcompanamientosocialComponent {
  datos: any = [];  
  filterPost!: string;
  p: number = 1;
